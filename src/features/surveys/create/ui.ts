...
const permissionsDeniedEmbeds = (surveyCreatorRoleId: string | null) => {
  const mentionRole =
    surveyCreatorRoleId === null
      ? surveyCreatorRoleId
      : roleMention(surveyCreatorRoleId);

  const orRole = mentionRole === null ? " " : ` or ${mentionRole} `;
...
const questionAskInput = (context: Context) => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.QuestionAskInput)
    .setLabel("Question")
    .setMaxLength(256)
...
const questionDescriptionInput = (context: Context) => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.QuestionDescriptionInput)
...
export const questionModal = (context: Context) => {
  return new ModalBuilder()
    ...
    .setCustomId(`${ComponentId.QuestionModal}${context.sessionId}`)
...
const questionTypeSelect = (context: Context) => {
  ...
  return new StringSelectMenuBuilder()
    .setCustomId(`${ComponentId.QuestionTypeSelect}${context.sessionId}`)
    .setOptions(options);
};
...
const choiceSelect = (context: Context) => {
  ...
  return new StringSelectMenuBuilder()
    .setCustomId(`${ComponentId.ChoiceSelect}${context.sessionId}`)
    .setOptions(options);
};
...
const addChoiceButton = (context: Context) => {
  ...
  return new ButtonBuilder()
    .setCustomId(`${ComponentId.AddChoiceButton}${context.sessionId}`)
...
const editChoiceButton = (context: Context) => {
  ...
  return new ButtonBuilder()
    .setCustomId(`${ComponentId.EditChoiceButton}${context.sessionId}`)
...
const editChoiceSettingsButton = ({ sessionId }: Context) =>
  new ButtonBuilder()
    .setCustomId(`${ComponentId.EditChoiceSettingsButton}${sessionId}`)
    .setEmoji("✏️")
...
const removeChoiceButton = (context: Context) => {
  ...
  return new ButtonBuilder()
    .setCustomId(`${ComponentId.RemoveChoiceButton}${context.sessionId}`)
    .setDisabled(numberOfChoices === 0)
    .setEmoji("➖")
...
const addQuestionButton = (context: Context) => {
  ...
  return new ButtonBuilder()
    .setCustomId(`${ComponentId.AddQuestionButton}${context.sessionId}`)
    .setDisabled(!valid)
    .setEmoji("➕")
...
const editQuestionButton = ({ sessionId }: Context) =>
  new ButtonBuilder()
    .setCustomId(`${ComponentId.EditQuestionButton}${sessionId}`)
    .setEmoji("✏️")
...
const removeQuestionButton = (context: Context) => {
  ...
  return new ButtonBuilder()
    .setCustomId(`${ComponentId.RemoveQuestionButton}${context.sessionId}`)
...
const createSurveyButton = (context: Context) => {
  ...
  return new ButtonBuilder()
    .setCustomId(`${ComponentId.CreateButton}${context.sessionId}`)
    .setDisabled(!valid)
    .setEmoji("✅")
...
const choiceLabelInput = (context: Context) => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.ChoiceLabelInput)
...
const choiceDescription = (context: Context) => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.ChoiceDescriptionInput)
...
export const choiceModal = (context: Context) =>
  new ModalBuilder()
    ...
    .setCustomId(`${ComponentId.ChoiceModal}${context.sessionId}`)
...
const choiceMinValuesInput = (context: Context) => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.ChoiceMinValuesInput)
...
const choiceMaxValuesInput = (context: Context) => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.ChoiceMaxValuesInput)
...
export const choiceSettingsModal = (context: Context) =>
  new ModalBuilder()
    ...
    .setCustomId(`${ComponentId.ChoiceSettingsModal}${context.sessionId}`)
...
const createSurveyDescriptionInput = () => {
  ...
  return new TextInputBuilder()
    .setCustomId(ComponentId.CreateSurveyDescriptionInput)
    .setLabel("Description")
    .setMaxLength(4000)
    .setPlaceholder(placeholder)
    .setRequired(false)
...
export const createSurveyModal = ({ sessionId }: Context) =>
  new ModalBuilder()
    ...
    .setCustomId(`${ComponentId.CreateSurveyModal}${sessionId}`)
